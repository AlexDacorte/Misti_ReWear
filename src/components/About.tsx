...
const features = [
  {
    ...
    description:
      "Reduce tu huella ambiental eligiendo ropa de segunda mano de calidad.",
    color: "bg-secondary",
  },
  {
    icon: Heart,
    title: "PIEZAS ÚNICAS",
    description:
      "Cada prenda tiene su historia y estilo único que no encontrarás en tiendas convencionales.",
    color: "bg-primary",
  },
  {
    icon: Shield,
    ...
    description:
      "Seleccionamos cuidadosamente cada prenda para asegurar su buen estado.",
    color: "bg-accent",
  },
  {
    icon: Truck,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <div className="space-y-4 font-mono text-muted-foreground text-lg">
              ...
              >
                Somos un emprendimiento arequipeño dedicado a darle una segunda
                vida a la ropa de calidad. Creemos que la moda sostenible no
                solo es buena para el planeta, sino también para tu bolsillo.
              </motion.p>
              <motion.p
              ...
              >
                Cada prenda es seleccionada con cuidado, lavada y presentada
                para que encuentres piezas únicas que reflejen tu estilo
                personal. ¡Únete al movimiento de moda consciente en Arequipa!
              </motion.p>
            </div>
